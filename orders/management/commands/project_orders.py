# orders/management/commands/project_orders.py
...
class Command(BaseCommand):
    help = "Догоняет проекцию OrderView/OrderItemView из EventStore (PurchaseOrder)."
    ...
    def handle(self, *args, **options):
        runner = ProjectorRunner(
            projector_name="order_view_projector",
        ...
        self.stdout.write(self.style.SUCCESS(f"Order projection: обработано событий: {total}"))